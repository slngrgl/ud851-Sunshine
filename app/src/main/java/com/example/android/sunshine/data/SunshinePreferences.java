...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        return prefs.getString(context.getString(R.string.pref_location_key),c ontext.getString(R.string.pref_location_default));
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        String preferredUnits = prefs.getString(context.getString(R.string.pref_units_key), context.getString(R.string.pref_units_metric));
        return context.getString(R.string.pref_units_metric).equals(preferredUnits);
    }
